...
llvm::FunctionType *
CGGenratorMemberFunction::createFunctionType(FunctionDeclaration *Proc){
...
void CGGenratorMemberFunction::run(FunctionDeclaration *Proc){
     this->Proc = Proc;
...
bool CGGenratorMemberFunction::emitSpecialStmt(Stmt *S) { 
